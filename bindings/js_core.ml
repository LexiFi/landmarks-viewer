...
module Document = struct
  ...
  let create_html_input document =
    ( create_element document "input" |> Element.unsafe_cast
      : Kinds.Html.input Element.t )

  let create_html_table document =
    ( create_element document "table" |> Element.unsafe_cast
      : Kinds.Html.table Element.t )

  let create_html_tr document =
    ( create_element document "tr" |> Element.unsafe_cast
      : Kinds.Html.tr Element.t )

  let create_html_td document =
    ( create_element document "td" |> Element.unsafe_cast
      : Kinds.Html.td Element.t )

  let create_html_th document =
    ( create_element document "th" |> Element.unsafe_cast
      : Kinds.Html.th Element.t )

  let create_html_tbody document =
    ( create_element document "tbody" |> Element.unsafe_cast
      : Kinds.Html.tbody Element.t )

  let create_html_thead document =
    ( create_element document "thead" |> Element.unsafe_cast
      : Kinds.Html.thead Element.t )
end
